...
{
    return (address >= WT_XSPI_NOR_WRITABLE_BASE) &&
           (address <= WT_XSPI_NOR_WRITABLE_END) &&
           (size <= WT_XSPI_NOR_WRITABLE_END - address);
}
