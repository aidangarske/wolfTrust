...
- wolfBoot, wolfTrust, the linked cryptographic libraries, the compiler, and
  the generated manifest are trusted and authenticated.
...
See [[Security Model]] for the implementation boundaries and [[STM32H5 Guide]]
