...
Zephyr and FreeRTOS guest builds additionally use Python virtual environments,
CMake, Ninja, and network access for their pinned workspaces.
...
[[Macros]] for the supported values and constraints.
...
The optional wolfIP switch is off by default:
...
See [[Getting Started]] for the shortest path and [[Testing]] for validation
commands.
