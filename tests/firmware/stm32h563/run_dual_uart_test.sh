...
WT_INSECURE_TEST_RNG="${WT_INSECURE_TEST_RNG:-1}"
...
make -C "$SCRIPT_DIR" WT_ENGINE_HSM="$WT_ENGINE_HSM" WT_INSECURE_TEST_RNG="$WT_INSECURE_TEST_RNG" WT_SHARED_UART="$WT_SHARED_UART" all >/dev/null
