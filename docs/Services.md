...
| `SERVICE_VNET` | `0x1007` | Yes, optional | Secure wolfIP virtual Ethernet switch |
...
assembly. [[TF-M Compatibility]] records these token-profile and API deviations.
...
See [[API Reference]] for client signatures and [[Macros]] for service build
controls.
